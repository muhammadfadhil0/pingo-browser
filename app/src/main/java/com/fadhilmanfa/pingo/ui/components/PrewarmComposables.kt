...
/**
 * Pre-warms (pre-composes) heavy UI components during the initial loading phase.
 * This forces Compose to cache the composition and layout calculations ahead of time,
 * making subsequent animations and displays much smoother.
 * 
 * The components are rendered with alpha = 0 and minimal size so they're invisible
 * to the user but still trigger Compose's internal caching mechanisms.
 */
@Composable
fun PrewarmComposables(
